...
function renderTable() {
    ...
    body.innerHTML = dataList.map((d, i) => {
        ...
        return `<tr class="hover:bg-gray-50 transition">
            ...
            <td class="py-3 px-5 text-xs text-gray-500">${d.kecamatan || '-'}</td>
            <td class="py-3 px-5 text-xs text-gray-500">${d.desa || '-'}</td>
            <td class="py-3 px-5 text-xs text-gray-500">${d.pihak_luar || '-'}</td>
            <td class="py-3 px-5 text-xs text-gray-600 font-medium">${d.penanggung_jawab || '-'}</td>
...
function initModal() {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        const payload = {
            ...
            penanggung_jawab: document.getElementById('f-pj').value || '-',
...
function editRow(id) {
    ...
    setTimeout(() => {
        ...
        document.getElementById('f-pj').value = d.penanggung_jawab || '';
